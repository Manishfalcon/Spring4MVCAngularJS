...
<html>
  <head>  
    <title>AngularJS HTTP Service Example Demo</title>  
    <style>
      .username.data-ng-valid {
          background-color: lightgreen;
      }
      .username.data-ng-dirty.data-ng-invalid-required {
          background-color: red;
      }
      .username.data-ng-dirty.data-ng-invalid-minlength {
      ...
      .email.data-ng-dirty.data-ng-invalid-required {
          background-color: red;
      }
      .email.data-ng-dirty.data-ng-invalid-email {
          background-color: yellow;
      }
                  ...
                  <form data-ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-sm-6">
                     	  ...
                     	  <div class="form-group col-sm-6"> 
                     	  		<label class="col-md-6 control-lable" for="file">Subject</label>
                     	  		<div class="col-md-2">
									<select>
										<option data-ng-repeat="x in ctrl.users">{{x.subject}}</option>
								</select>
							</div>
                     	  </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-actions floatRight">
                              <input type="submit"  value="{{!ctrl.user.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm" data-ng-disabled="myForm.$invalid">
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr data-ng-repeat="u in ctrl.users">
                              ...
                              <td>
                              <button type="button" data-ng-click="ctrl.edit(u.id)" class="btn btn-success custom-width">Edit</button>  <button type="button" data-ng-click="ctrl.remove(u.id)" class="btn btn-danger custom-width">Remove</button>
                              </td>
                          </tr>
                      </tbody>
                  </table>
